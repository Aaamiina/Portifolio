...
export default function SectionHeading({ eyebrow, title, description, align = 'left' }) {
  return (
    ...
    >
      ...
      <h2 className="font-display text-[1.45rem] font-bold tracking-[-0.03em] text-paper sm:text-2xl md:text-[1.85rem] md:leading-[1.15]">
        {title}
      </h2>
      {description ? (
        <p className="mt-4 max-w-xl text-[0.95rem] leading-7 text-mute">{description}</p>
      ) : null}
      <span
